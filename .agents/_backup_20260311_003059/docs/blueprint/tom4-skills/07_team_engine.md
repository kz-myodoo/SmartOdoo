# 🚀 TeamEngine — Silnik Orkiestracji v3.0 (Lean)
...
W rozmowie: **`deploy engine`** lub **`/so`** → poprowadzi (komendy PowerShell w `.agents/workflows/so.md`).
...
| `.agents/workflows/*.md` | pm, arch, dev, qa, sec, anal |
